...
namespace ValveResourceFormat.Renderer2.Materials
{
    ...
    public class RenderMaterial
    {
        ...
        /// </summary>
        //VKTODO: what are we doing here? public bool ReadsSceneColor => Shader.ReadsSceneColor;
        ...
        //VKTODO: private int GetSortId() => Shader.Program * PerShaderSortIdRange + Random.Shared.Next(1, 9999);
        ...
        {
            Material = material;
            ShaderName = material.ShaderName; //VKTODO: normalizeShaderName ? NormalizeShaderName(material.ShaderName) : 
        ...
        //VKTODO: private static string NormalizeShaderName(string shaderName)
        //{
        ...
        /// </param>
        //VKTODO: internal void BindGlobals(Shader shader)
        //{
