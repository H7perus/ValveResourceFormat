    ...
    class GLModelViewer : GLSingleNodeViewer
    {
        ...
        protected override void LoadScene()
        {
            ...
            if (model != null)
            {
                ...
                //VKTODO: animationController = modelSceneNode.AnimationController;
            ...
            {
                //VKTODO: Picker?.OnPicked -= OnPicked;
            }
        ...
        protected unsafe override void OnPaint(float frameTime)
        {
            ...
            //    Matrix4x4? viewMatrix = Matrix4x4.CreateTranslation(new Vector3(0, 0, -300)); // * Matrix4x4.Identity; // Renderer?.Camera?.CameraViewMatrix;

            //    //Matrix4x4.CreateRotationZ()

            //    //Matrix4x4.CreateTranslation(new Vector3(0, -200, 0));
            ...
            //if (modelSceneNode != null)//VKTODO: && SelectedNodeRenderer != null)
            //{
        ...
        private string GetActiveLodText()
        {
            ...
            return "//VKTODO:";//modelSceneNode.IsAutoLod
